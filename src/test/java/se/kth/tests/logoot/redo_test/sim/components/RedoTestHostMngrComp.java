 ...
 */
public class RedoTestHostMngrComp extends ComponentDefinition {

    private static final Logger LOG = LoggerFactory.getLogger(RedoTestHostMngrComp.class);
    ...
    public RedoTestHostMngrComp(Init init) {
    ...
    private void connectApp() {
        RedoTestAppMngrComp.ExtPort extPorts = new RedoTestAppMngrComp.ExtPort(timerPort, networkPort, overlayMngrComp.getPositive(CroupierPort.class), overlayMngrComp.getNegative(OverlayViewUpdatePort.class));
        appMngrComp = create(RedoTestAppMngrComp.class, new RedoTestAppMngrComp.Init(extPorts, selfAdr, croupierId, numberOfInsertions));
        connect(appMngrComp.getNegative(OverlayMngrPort.class), overlayMngrComp.getPositive(OverlayMngrPort.class), Channel.TWO_WAY);
    }

    public static class Init extends se.sics.kompics.Init<RedoTestHostMngrComp> {
