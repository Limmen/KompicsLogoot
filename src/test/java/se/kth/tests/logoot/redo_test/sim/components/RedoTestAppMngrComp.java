 ...
 */
public class RedoTestAppMngrComp extends ComponentDefinition {

    private static final Logger LOG = LoggerFactory.getLogger(RedoTestAppMngrComp.class);
    ...
    public RedoTestAppMngrComp(Init init) {
    ...
    private void connectAppCompSimp() {
        appComp = create(RedoTestAppComp.class, new RedoTestAppComp.Init(selfAdr, croupierId, numberOfInsertions));
    ...
    public static class Init extends se.sics.kompics.Init<RedoTestAppMngrComp> {
