 ...
 */
public class DeleteTestAppMngrComp extends ComponentDefinition {

    private static final Logger LOG = LoggerFactory.getLogger(DeleteTestAppMngrComp.class);
    ...
    public DeleteTestAppMngrComp(Init init) {
    ...
    private void connectAppCompSimp() {
        appComp = create(DeleteTestAppComp.class, new DeleteTestAppComp.Init(selfAdr, croupierId, numberOfInsertions, numberOfDeletions));
    ...
    public static class Init extends se.sics.kompics.Init<DeleteTestAppMngrComp> {
        ...
        public Init(ExtPort extPorts, KAddress selfAdr, OverlayId croupierOId, int numberOfInsertions, int numberOfDeletions) {
