 ...
 */
public class DeleteTestHostMngrComp extends ComponentDefinition {

    private static final Logger LOG = LoggerFactory.getLogger(DeleteTestHostMngrComp.class);
    ...
    public DeleteTestHostMngrComp(Init init) {
    ...
    private void connectApp() {
        DeleteTestAppMngrComp.ExtPort extPorts = new DeleteTestAppMngrComp.ExtPort(timerPort, networkPort, overlayMngrComp.getPositive(CroupierPort.class), overlayMngrComp.getNegative(OverlayViewUpdatePort.class));
        appMngrComp = create(DeleteTestAppMngrComp.class, new DeleteTestAppMngrComp.Init(extPorts, selfAdr, croupierId, numberOfInsertions, numberOfDeletions));
        connect(appMngrComp.getNegative(OverlayMngrPort.class), overlayMngrComp.getPositive(OverlayMngrPort.class), Channel.TWO_WAY);
    }

    public static class Init extends se.sics.kompics.Init<DeleteTestHostMngrComp> {
        ...
        public Init(KAddress selfAdr, KAddress bootstrapServer, OverlayId croupierId, int numberOfInsertions, int numberOfDeletions) {
