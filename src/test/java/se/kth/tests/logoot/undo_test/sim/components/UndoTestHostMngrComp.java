 ...
 */
public class UndoTestHostMngrComp extends ComponentDefinition {

    private static final Logger LOG = LoggerFactory.getLogger(UndoTestHostMngrComp.class);
    ...
    public UndoTestHostMngrComp(Init init) {
    ...
    private void connectApp() {
        UndoTestAppMngrComp.ExtPort extPorts = new UndoTestAppMngrComp.ExtPort(timerPort, networkPort, overlayMngrComp.getPositive(CroupierPort.class), overlayMngrComp.getNegative(OverlayViewUpdatePort.class));
        appMngrComp = create(UndoTestAppMngrComp.class, new UndoTestAppMngrComp.Init(extPorts, selfAdr, croupierId, numberOfInsertions));
        connect(appMngrComp.getNegative(OverlayMngrPort.class), overlayMngrComp.getPositive(OverlayMngrPort.class), Channel.TWO_WAY);
    }

    public static class Init extends se.sics.kompics.Init<UndoTestHostMngrComp> {
