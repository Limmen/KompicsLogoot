 ...
 */
public class UndoTestAppMngrComp extends ComponentDefinition {

    private static final Logger LOG = LoggerFactory.getLogger(UndoTestAppMngrComp.class);
    ...
    public UndoTestAppMngrComp(Init init) {
    ...
    private void connectAppCompSimp() {
        appComp = create(UndoTestAppComp.class, new UndoTestAppComp.Init(selfAdr, croupierId, numberOfInsertions));
    ...
    public static class Init extends se.sics.kompics.Init<UndoTestAppMngrComp> {
