 ...
 */
public class UndoTestAppComp extends ComponentDefinition {
    ...
    public UndoTestAppComp(Init init) {
    ...
    public static class Init extends se.sics.kompics.Init<UndoTestAppComp> {
