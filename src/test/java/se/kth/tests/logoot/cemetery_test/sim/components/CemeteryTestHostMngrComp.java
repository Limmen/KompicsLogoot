 ...
 */
public class CemeteryTestHostMngrComp extends ComponentDefinition {

    private static final Logger LOG = LoggerFactory.getLogger(CemeteryTestHostMngrComp.class);
    ...
    public CemeteryTestHostMngrComp(Init init) {
    ...
    private void connectApp() {
        CemeteryTestAppMngrComp.ExtPort extPorts = new CemeteryTestAppMngrComp.ExtPort(timerPort, networkPort, overlayMngrComp.getPositive(CroupierPort.class), overlayMngrComp.getNegative(OverlayViewUpdatePort.class));
        appMngrComp = create(CemeteryTestAppMngrComp.class, new CemeteryTestAppMngrComp.Init(extPorts, selfAdr, croupierId, numberOfInsertions));
        connect(appMngrComp.getNegative(OverlayMngrPort.class), overlayMngrComp.getPositive(OverlayMngrPort.class), Channel.TWO_WAY);
    }

    public static class Init extends se.sics.kompics.Init<CemeteryTestHostMngrComp> {
