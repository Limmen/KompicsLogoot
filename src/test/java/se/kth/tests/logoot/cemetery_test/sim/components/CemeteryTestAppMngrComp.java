 ...
 */
public class CemeteryTestAppMngrComp extends ComponentDefinition {

    private static final Logger LOG = LoggerFactory.getLogger(CemeteryTestAppMngrComp.class);
    ...
    public CemeteryTestAppMngrComp(Init init) {
    ...
    private void connectAppCompSimp() {
        appComp = create(CemeteryTestAppComp.class, new CemeteryTestAppComp.Init(selfAdr, croupierId, numberOfInsertions));
    ...
    public static class Init extends se.sics.kompics.Init<CemeteryTestAppMngrComp> {
