...
import se.kth.app.InsertTestAppComp;
 ...
 */
public class InsertTestAppMngrComp extends ComponentDefinition {

    private static final Logger LOG = LoggerFactory.getLogger(InsertTestAppMngrComp.class);
    ...
    public InsertTestAppMngrComp(Init init) {
    ...
    private void connectAppCompSimp() {
        appComp = create(InsertTestAppComp.class, new InsertTestAppComp.Init(selfAdr, croupierId, numberOfInsertions));
    ...
    public static class Init extends se.sics.kompics.Init<InsertTestAppMngrComp> {
        ...
        public Init(ExtPort extPorts, KAddress selfAdr, OverlayId croupierOId, int numberOfInsertions) {
