 ...
 */
public class BEBTestAppComp extends ComponentDefinition {

    private static final Logger LOG = LoggerFactory.getLogger(BEBTestAppComp.class);
    ...
    public BEBTestAppComp(Init init) {
    ...
    public static class Init extends se.sics.kompics.Init<BEBTestAppComp> {
