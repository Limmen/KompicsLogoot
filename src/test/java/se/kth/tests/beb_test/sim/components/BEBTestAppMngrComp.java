 ...
 */
public class BEBTestAppMngrComp extends ComponentDefinition {

    private static final Logger LOG = LoggerFactory.getLogger(BEBTestAppMngrComp.class);
    ...
    public BEBTestAppMngrComp(Init init) {
    ...
    public static class Init extends se.sics.kompics.Init<BEBTestAppMngrComp> {
